...

{
    ...
    protected $table = 'profile_awardee';
    ...
    //
    public function userLoginProfileMerged() {
        $lib = 'App\Models\UserLogin';
        return $this->hasMany($lib);
    }

    public function infoBeaMStatus() {
        $lib = 'App\Models\MStatus';
        return $this->belongsTo($lib, 'id_status_beasiswa', 'id');
    }
    public function infoBeaMJenjang() {
        $lib = 'App\Models\MJenjang';
        return $this->belongsTo($lib, 'id_jenjang_studi', 'id');
    }
    public function infoBeaPengayaanBahasa() {
        $lib = 'App\Models\PengayaanBahasa';
        return $this->belongsTo($lib, 'id', 'id_profile');
    }

    public function infoProfileOtherData() {
        $lib = 'App\Models\OtherPersonalData';
        return $this->belongsTo($lib, 'kode_registrasi', 'KodeRegistrasi');
    }
    public function infoProfileMKota() {
        $lib = 'App\Models\MKota';
        return $this->belongsTo($lib, 'id_kabkota_asal', 'id');
    }
    public function infoProfileMNegara() {
        $lib = 'App\Models\MNegara';
        return $this->belongsTo($lib, 'id_negara', 'id');
    }
